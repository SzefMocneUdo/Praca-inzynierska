...
List<Item> generateItems() {
  ...
  items.add(Item(
    ...
    expandedValue: 'To use the app, log in and start adding incomes and outcomes. '
        'Main screen of the app contains your statistics and charts based on your expenses.'
        'You can switch between different pages to see more info about your money.',
  ));
  ...
  items.add(Item(
    ...
    expandedValue: 'To add a new saving goal You need to hold "+" button placed on the navigation bar for 2 seconds.'
  ...
  items.add(Item(
    ...
    expandedValue: 'To view current currency rates You need to press "Currency" button placed on the left side of the navigation bar.'
  ...
  items.add(Item(
    ...
    expandedValue: 'To view financial overview You need to press "Transaction" button placed on the navigation bar.'
  ...
  items.add(Item(
    ...
    expandedValue: 'To view main screen You need to press "+" button placed on the navigation bar.'
  ...
  items.add(Item(
    ...
    expandedValue: 'To view saving goals You need to press "Goals" button placed on the navigation bar.'
        'You should see Goals screen that displays your saving goals.'
  ));

  items.add(Item(
      headerValue: 'How to open settings?',
      expandedValue: 'To open settings You need to press "Settings" button placed on the right side of the navigation bar.'
  ...
  items.add(Item(
      ...
      expandedValue: 'To view calendar You need to open settings and press "Calendar" button in "Features" section.'
          'You should see Calendar screen that displays your saving goals and plans.'
          'You can edit them by clicking on the calendar windows.'
  ));
  items.add(Item(
      headerValue: 'How to view credit cards?',
      expandedValue: 'To view credit cards You need to open settings and press "Cards" button in "Features" section.'
          'You should see Cards screen that displays your attached credit cards.'
          'You can edit them by clicking on the card widget.'
  ));
